...
$(function() {
    ...
    function initWeek() {
      for (i=0; i<=39; i++)
      {
        $('.days').append('<div class="day"><div class="label"></div><div class="icon style' + String(i).padStart(2, '0') + '"><div class="moon"></div><div class="sun"><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div></div><div class="cloud sidecloud-left"></div><div class="snow snow-sidecloud-left"><div class="snowflake-row"><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div></div><div class="snowflake-row"><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div></div></div><div class="cloud sidecloud-right"></div><div class="rain rain-sidecloud-right"></div><div class="cloud largecloud"></div><div class="rain rain-largecloud"></div><div class="snow snow-largecloud"><div class="snowflake-row"><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div></div><div class="snowflake-row"><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div><div class="snowflake"></div></div></div><div class="cloud backcloud"></div></div><div class="highlow"><div class="high" data-animate-to="24"></div><div class="low" data-animate-to="17"></div></div><div class="details"><div><div>Mostly sunny.</div></div></div></div>')
      }
      // if (!weekly_data)
      //   getWeekData();
    }
